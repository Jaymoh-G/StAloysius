                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu fade-down">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('clc') }}">Christian Life Community</a>
                            </li>
                        </ul>
                    </li>

                    <li class="nav-item mega-menu dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('departments') }}"
                                                    ...
                                                    @foreach ($mainCategory->children as $subCategory)
                                                        <li class="dropdown-submenu">
                                                            <a class="dropdown-item dropdown-toggle"
                                                                href="{{ route('departments') }}?category={{ $subCategory->slug }}">
                                                                {{ $subCategory->name }}
                                                            </a>
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                @empty
                                                                    <li>
                                                                        <a class="dropdown-item disabled">No departments
                                                                            available</a>
                                                                    </li>
                                                                @endforelse
                                                            </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu fade-down">
                            <li>
                                <a class="dropdown-item" href="{{ route('admission-policy') }}">Admission Policy</a>
                            </li>

                            <li>
                                <a class="dropdown-item" href="{{ route('scholarships') }}">Scholarships</a>
                            </li>

                            <li>
                                <a class="dropdown-item" href="{{ route('fee-paying-students') }}">Fees Paying
                                    Students</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('how-to-apply') }}">How to Apply</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('media-centre') }}"
                            data-bs-toggle="dropdown">Media Centre</a>
                        <ul class="dropdown-menu fade-down">
                            <li>
                            ...
                            <li class="nav-item dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('upcoming-events') }}">Upcoming
                                            Events</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('past-events') }}">Past Events</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown-submenu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">School
                            Portals</a>
                        <ul class="dropdown-menu fade-down">
                            <li>
                                <a class="dropdown-item"
                                    href="http://192.168.0.77:8080/cgi-bin/koha/mainpage.pl">Student Portal</a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="https://onlinesmis.com/index.php?id=nbi_stagss&portal">Staff Portal</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="https://staloysiusgonzaga.ac.ke/webmail">Webmails</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <div class="nav-item dropdown">
                        <div class="nav-right-btn nav-link dropdown mt-2">
                            <a href="{{ route('support-us') }}" class="theme-btn"><span
                                    class="fal fa-pencil"></span>Support
                                Us</a>
                            <ul class="dropdown-menu fade-down">
                                <li>
                                    <a class="dropdown-item" href="{{ route('support-us') }}">Donate</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('events') }}">Projects</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('events') }}">Volunteer your Services</a>
                                </li>
