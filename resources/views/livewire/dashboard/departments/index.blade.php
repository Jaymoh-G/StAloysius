    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table
                    class="table-hover table-responsive-sm table align-middle"
                >
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-wrap gap-2">
                                    @php $featured =
                                    $dep->images->where('is_featured',
                                    true)->first(); $others =
                                    $dep->images->where('is_featured',
                                    false)->take(4); @endphp @if ($featured)
                                    <div class="position-relative">
                                        ...
                                        />
                                        <span
                                            class="position-absolute start-0 top-0 m-1 bg-white"
                                            ><i
                            ...
                            <td class="text-end">
                                <a
                                    ...
                                    class="btn btn-success btn-xs sharp me-1 shadow"
                                    title="view"
                                    target="_blank"
                                >
                                ...
                                <a
                                    href="{{ route('dashboard.departments.edit', $dep->id) }}"
                                ...
                                <button
                                    class="btn btn-danger btn-xs sharp me-1 shadow"
