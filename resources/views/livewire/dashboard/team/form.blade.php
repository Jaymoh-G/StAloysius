    ...
    <div>
        <form wire:submit.prevent="save" class="space-y-4">
            ...
            <div class="flex gap-2">
                <input
                    type="text"
                    wire:model.lazy="newSkill"
                    placeholder="Skill name"
                />
                <input
                    type="number"
                    wire:model.lazy="newPercent"
                    placeholder="%"
                    min="0"
                    max="100"
                />
            ...
            <div class="flex gap-2">
                <input
                    type="text"
                    class="input"
                    wire:model="socials.{{ $platform }}"
                    placeholder="{{ ucfirst($platform) }}"
                />
                <button
                    type="button"
            ...
            <div class="flex gap-2">
                <input
                    type="text"
                    wire:model.lazy="newSocial"
                    placeholder="Platform"
                />
                <input
                    type="text"
                    wire:model.lazy="newSocialLink"
                    placeholder="URL"
                />
                <button
                    type="button"
