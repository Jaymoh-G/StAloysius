        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        {{ $jobId ? "Edit Job Vacancy" : "Create Job Vacancy" }}
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select
                                    class="form-select @error('job_category_id') is-invalid @enderror"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    wire:model="application_email"
                                    placeholder="Enter email for applications"
                                />
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                @enderror @if($existingPdfPath)
                                <div class="mt-2">
                                    <a
                                        href="{{
                                            asset('storage/'.$existingPdfPath)
                                        }}"
                                        target="_blank"
