                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">
                            Manage YouTube videos for your website
                        </h6>
                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            <div class="mb-3">
                                                ...
                                                >
                                                <select
                                                    class="form-select @error('album_category_id') is-invalid @enderror"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input
                                                    type="file"
                                                    class="form-control @error('temp_thumbnail') is-invalid @enderror"
                                                    wire:model="temp_thumbnail"
                                                    accept="image/*"
                                                />
                                                ...
                                                <div class="mt-2">
                                                    <img
                                                        src="{{ $temp_thumbnail->temporaryUrl() }}"
                                                        class="img-thumbnail"
                                                        style="
                                                            max-height: 150px;
                                                        "
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <button
                                                        ...
                                                        wire:click="triggerRemoveThumbnail"
                                                    >
                                                        <i
                                                            class="fa fa-trash"
                                                        ></i>
                                            ...
                                            <tr>
                                                <td style="width: 120px">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <i
                                                                class="fa fa-play-circle text-white"
                                                                style="
                                                                    font-size: 2rem;
                                                                    opacity: 0.8;
                                                                "
        ...
        Livewire.on('confirmDelete', (data) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire(
                        'Deleted!',
                        'YouTube video has been deleted.',
                        'success'
                    )
                }
            })
