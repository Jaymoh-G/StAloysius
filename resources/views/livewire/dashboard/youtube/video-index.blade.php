                                        ...
                                        <form wire:submit.prevent="{{ $isEditing ? 'update' : 'create' }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @error('video_id')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <small class="text-muted">Paste the full YouTube URL or just the video
                                                    ID</small>
                                            </div>
                                            ...
                                            <div class="form-check mb-3">
                                                ...
                                                <label class="form-check-label" for="featuredCheck">Featured
                                                    Video</label>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @if ($temp_thumbnail)
                                                    <div class="mt-2">
                                                        <img src="{{ $temp_thumbnail->temporaryUrl() }}"
                                        ...
                                        <tbody>
                                            @forelse($videos as $video)
                                                <tr>
                                                    ...
                                                    <td>{{ $video->category ? $video->category->name : 'Uncategorized' }}
                                                    </td>
                                                    <td>
