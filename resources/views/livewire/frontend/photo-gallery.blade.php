                        ...
                        <div class="col-12">
                            ...
                            <div class="gallery-filter livewire-filter d-flex justify-content-center flex-wrap">
                                <a href="{{ route('photos') }}" wire:navigate
                                    class="theme-btn btn-sm {{ empty($categoryFilter) ? 'active' : '' }} m-2">
                                    <i class="fas fa-images me-1"></i> All Albums
                                </a>
                                @foreach ($categories as $category)
                                    <a href="{{ route('photos.categories', ['category' => $category->slug]) }}"
                                        wire:navigate
                                        class="theme-btn btn-sm {{ $categoryFilter == $category->slug ? 'active' : '' }} m-2">
                            ...
                            <div class="gallery-item">
                                <div class="gallery-img" style="height: 250px; position: relative;">
                                    ...
                                    <div class="gallery-content"
                                        style="position: absolute; top: 0; left: 0; width: 100%; height: 250px; z-index: 5;">
                                        <div
                                            style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center;">
                                            <a class="popup-img gallery-link"
                                                href="{{ $album->cover_image ? asset('storage/' . $album->cover_image) : '' }}">
                                ...
                                <div class="gallery-info position-relative text-dark bg-white">
                                    <div class="d-flex justify-content-between align-items-center w-100">
                                        <div>
                                            <h5 class="album-title text-dark mb-0">{{ Str::limit($album->title, 35) }}</h5>
                                            <p class="album-count text-muted mb-0"><i
                                                    class="far fa-images me-1"></i>{{ $album->images_count }} Photos</p>
                                        </div>
