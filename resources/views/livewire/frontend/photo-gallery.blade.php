            ...
            <div class="row mb-5">
                <div class="col-12">
                    ...
                    >
                        ...
                        <a
                            href="{{ route('photos.categories', ['category' => $category->slug]) }}"
                            wire:navigate
            ...
            <div class="row g-4">
                ...
                >
                    <div class="gallery-item">
                        ...
                        <div
                            class="gallery-info position-relative text-dark bg-white"
                        >
                            <div
                                class="d-flex justify-content-between align-items-center w-100"
                            >
                                <div>
                                    <h5 class="album-title text-dark mb-0">
                                        {{ Str::limit($album->title, 35) }}
                                    </h5>
                                    <p class="album-count text-muted mb-0">
                ...
                <div class="col-12 py-5 text-center">
                    <div class="alert alert-info">
                        ...
                        <p>
                            There are no photo albums available in this
                            category.
                        </p>
                    </div>
                </div>
                ...
                jQuery(".popup-img").magnificPopup({
                    ...
                    callbacks: {
                        ...
                        open: function () {
                            ...
                            if (
                                magnificPopup &&
                                magnificPopup.contentContainer
                            ) {
                                setTimeout(function () {
