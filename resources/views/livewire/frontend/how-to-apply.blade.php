                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="content-info wow fadeInUp" data-wow-delay=".25s">
                                <div class="site-heading mb-3">
                                    ...
                                    <h2 class="site-title">
                                        <span>{{ $howToApply->title ?? 'How To Apply' }}</span>.
                                    </h2>
                                </div>
                                ...
                                <div class="row my-3">
                                    <div class="col-md-6">
                                        <ul class="content-list">
                                            <li>
                                                <i class="fas fa-check-circle"></i>Start Online Submission
                                            </li>
                                            <li>
                                                <i class="fas fa-check-circle"></i>Submit The Form
                                            </li>
                                            <li>
                                                <i class="fas fa-check-circle"></i>Review The Submission
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="content-list">
                                            <li>
                                                <i class="fas fa-check-circle"></i>Gather Necessary Documents
                                            </li>
                                            <li>
                                                <i class="fas fa-check-circle"></i>Interviewing Process
                                            </li>
                                            <li>
                                                <i class="fas fa-check-circle"></i>Last Decision
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="content-img wow fadeInRight" data-wow-delay=".25s">
                                <img src="{{ $howToApply->image ? asset('storage/' . $howToApply->image) : asset('assets/img/apply/01.jpg') }}"
                                    alt="" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="details-right">
                                    ...
                                    <ul class="content-list mt-2">
                                        ...
                                        <li>
                                            <i class="fas fa-check-circle"></i>Dolores eos qui ratione voluptatem
                                            sequi nesciunte porro quisquam est.
                                        </li>
                                        <li>
                                            <i class="fas fa-check-circle"></i>Adipisci velit sed quia non numquam
