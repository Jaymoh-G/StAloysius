                ...
                <div class="container">
                    <div class="health-care-content">
                        @if ($admissionPolicy)
                            ...
                            @for ($i = 1; $i <= 10; $i++)
                                @php$sectionTitle = "section_{$i}_title";
                                $sectionContent = "section_{$i}_content"; @endphp
                                @if ($admissionPolicy->$sectionTitle || $admissionPolicy->$sectionContent)
                                    <div class="my-4">
                                        @if ($admissionPolicy->$sectionTitle)
                                            ...
                                            @endif @if ($admissionPolicy->$sectionContent)
                                                ...
                                                @endif @php $images = $admissionPolicy->sectionImages($i); @endphp @if ($images && $images->count() > 0)
                                                    <div class="row mt-4">
