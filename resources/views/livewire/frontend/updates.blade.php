                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                                    ...
                                    <div class="blog-item-img">
                                        <img src="{{ asset('storage/' . $new->banner) }}" alt="Thumb" />
                                    </div>
                                    <div class="blog-item-info">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a
                                                        ...
                                                        <i class="far fa-tag"></i> {{ $new->category->name }}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <h4 class="{{ $new->title }}">
                                            <a
                                                href="{{ route('news.single', $new->slug) }}">{{ Str::limit(strip_tags($new->content), 60) }}</a>
                                        </h4>
                                        <a class="theme-btn" href="{{ route('news.single', $new->slug) }}">Read More<i
