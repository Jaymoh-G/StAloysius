<div>
    @section('content')
        ...
        <div class="site-breadcrumb" style="background: url({{ $selectedCategoryBanner ? asset('storage/' . $selectedCategoryBanner) : asset('assets/img/breadcrumb/01.jpg') }})">
            <div class="container">
                <h2 class="breadcrumb-title">
                    {{ $categoryFilter ? \App\Models\JobCategory::where('slug', $categoryFilter)->value('name') : 'Careers' }}
                </h2>
                    ...
                    <div class="col-md-12 mx-auto">
                        <div class="gallery-filter livewire-filter d-flex justify-content-center flex-wrap">
                            <a href="{{ route('careers') }}" wire:navigate
                                class="theme-btn btn-sm text-normal {{ empty($categoryFilter) ? 'active' : '' }} m-2">
                                <i class="fas fa-briefcase me-1"></i> All Jobs
                            </a>
                            @foreach ($categories as $category)
                                <a href="{{ route('careers.category', ['category' => $category->slug]) }}" wire:navigate
                                    class="theme-btn btn-sm text-normal {{ $categoryFilter == $category->slug ? 'active' : '' }} m-2">
                    ...
                    <div class="col-12">
                                ...
                                <div class="career-item mb-4">
                                    <div class="career-content">
                                        ...
                                        <div class="career-meta">
                                            ...
                                            <span class="text-danger"><i class="far fa-calendar"></i> Deadline:
                        ...
                        @else
                            <div class="py-5 text-center">
                                <i class="far fa-briefcase fa-3x text-muted mb-3"></i>
