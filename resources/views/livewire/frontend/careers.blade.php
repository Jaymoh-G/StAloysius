    ...
    <div
        ...
        style="background: url({{
            $selectedCategoryBanner
                ? asset('storage/'.$selectedCategoryBanner)
                ...
                <div class="col-md-12 mx-auto">
                    ...
                    >
                        <a
                            href="{{ route('careers') }}"
                            wire:navigate
                            class="theme-btn btn-sm text-normal {{
                        ...
                        <a
                            href="{{ route('careers.category', ['category' => $category->slug]) }}"
                            wire:navigate
                    ...
                    <div class="career-item mb-4">
                        <div class="career-content">
                            <h4>
                                ...
                                >
                                    <i
                                        class="fas fa-file-pdf text-success ms-2"
                                    ></i>
                                </a>
                                @else
                                <i
                                    class="fas fa-file-pdf text-muted ms-2"
                            ...
                            <div class="career-meta">
                                ...
                                <span class="text-danger"
                                    ><i class="far fa-calendar"></i> Deadline:
