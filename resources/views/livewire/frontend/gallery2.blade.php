                            ...
                            @foreach ($albums->take(2) as $album)
                                <div class="gallery-item mb-3">
                                    <div class="gallery-img" style="height: 300px;">
                                        @if ($album->cover_image)
                                            <img src="{{ asset('storage/' . $album->cover_image) }}"
                                                alt="{{ $album->title }}" class="img-fluid h-100 w-100 object-fit-cover" />
                                        @else
                                    ...
                                    <div class="gallery-info">
                                        ...
                                        <p class="album-count d-inline-block"><i
                                                class="far fa-images me-1"></i>{{ $album->images ? $album->images->count() : 0 }}
                                            Photosc</p>
