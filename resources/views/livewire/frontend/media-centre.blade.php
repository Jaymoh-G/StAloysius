    ...
    <main class="main">
        ...
        <div class="event-area bg-light py-120">
            <div class="container">
                ...
                <div class="row">
                    ...
                    @else @foreach($upcomingEvents as $event)
                    <div class="col-lg-4">
                        <div class="event-item">
                            ...
                            <div class="event-img">
                                ...
                                <img
                                    src="{{
                                        asset('assets/img/event/default.jpg')
                                    }}"
                                    alt="{{ $event->name }}"
                                />
                                @endif
        ...
        <div class="blog-area py-120">
            <div class="container">
                ...
                <div class="row">
                    ...
                    @else @foreach($latestNews as $news)
                    <div class="col-md-6 col-lg-4">
                        ...
                        >
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a
                                        href="{{ route('news.single', $news->slug) }}"
                                        >{{ $news->title }}</a
                                    >
                                </h4>
                                <p>
                                    {{ str(strip_tags($news->content))->limit(80) }}
                                </p>
                                <a
                                    class="theme-btn"
                                    href="{{ route('news.single', $news->slug) }}"
        ...
        <div class="gallery-area py-120">
            ...
            <div class="row">
                    <div class="col-lg-12">
                        ...
                        >
                            <div class="site-heading mb-0">
                                ...
                                <p class="mb-0">
                                Explore moments captured from various school
                ...
                @php // Get random albums with cover images $randomAlbums =
                \App\Models\Album::whereNotNull('cover_image') ->inRandomOrder()
                ->take(8) ->get(); @endphp
                        ...
                        <div class="gallery-img" style="height: 250px">
                            ...
                            <div class="gallery-content">
                                <div class="gallery-action-buttons">
                                    ...
                                    <a
                                        class="gallery-link view-album-link"
                    ...
                    <div class="gallery-item">
                        <div class="gallery-img" style="height: 250px">
                            ...
                            <div class="gallery-info">
                                ...
                                <p class="album-count">
                                    <i class="far fa-images me-1"></i>0 Photos
                                </p>
                            </div>
                            <div class="gallery-content">
                                <div class="gallery-action-buttons">
             ...
             <div class="row">
                    <div class="col-lg-12">
                        ...
                        >
                            <div class="site-heading mb-0">
                                <h2 class="site-title">
                                        Careers <span>Opportunities</span>
                                </h2>
                                <p class="mb-0">
                                   Join our team of dedicated educators and staff. Explore current openings.
                                </p>
                            </div>
                            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <p>
                            No job vacancies available at the moment. Please
                            check back later.
                        </p>
                    </div>
                    @else @foreach($latestJobs as $job)
                    <div class="col-md-6 col-lg-6">
                        ...
                        >
                            <div class="blog-date">
                                <i class="fal fa-calendar-alt"></i> Deadline:
            ...
            <div class="container">
                <div class="row mb-4">
                    ...
                    >
                        <div class="site-heading mb-0">
                            <h2 class="site-title">
                                Recent <span>Downloads</span>
                            </h2>
                            <p class="mb-0">
                                Access the latest downloadable resources from
                                our school.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('downloads') }}" class="theme-btn"
                                >View All Downloads<i
                                    class="fas fa-arrow-right-long"
                                ></i
                            ></a>
                        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 text-center py-5">
                        ...
                        <h5>No recent downloads found.</h5>
                    </div>
                    @endforelse
                </div>
            </div>
        </div>
        <!-- Recent Downloads section end -->
        <style>
            .gallery-item {
                position: relative;
                margin-bottom: 20px;
