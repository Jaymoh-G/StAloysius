...
return new class extends Migration
{
    ...
    {
        Schema::table('department_models', function (Blueprint $table) {
    ...
    {
        Schema::table('department_models', function (Blueprint $table) {
            $table->dropColumn(['paragraph8', 'paragraph9', 'paragraph10', 'paragraph11', 'paragraph12', 'paragraph13', 'paragraph14', 'paragraph15', 'paragraph16', 'paragraph17', 'paragraph18', 'paragraph19', 'paragraph20', 'paragraph21']);
        });
    }
};
