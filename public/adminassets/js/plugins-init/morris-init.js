    ...
    var dlabMorris = (function () {
        ...
        var donutChart = function () {
            Morris.Donut({
                ...
                resize: true,
                redraw: true,
                colors: ["#5e72e4", "rgb(255, 92, 0)", "#FF5E4B"],
                //responsive:true,
            });
        };
        ...
        var lineChart2 = function () {
            ...
            Morris.Area({
                ...
                pointSize: 3,
                fillOpacity: 0,
                pointStrokeColors: ["#EE3C3C", "#FF5E4B", "#5e72e4"],
                behaveLikeLine: true,
                gridLineColor: "transparent",
                lineWidth: 3,
                hideHover: "auto",
                lineColors: ["rgb(238, 60, 60)", "rgb(0, 171, 197)", "#5e72e4"],
                resize: true,
            });
        };
        ...
        var barChart = function () {
            if (jQuery("#morris_bar").length > 0) {
                ...
                Morris.Bar({
                    ...
                    ykeys: ["a", "b", "c"],
                    labels: ["A", "B", "C"],
                    barColors: ["#5e72e4", "#FF5E4B", "#ff9f00"],
                    hideHover: "auto",
                    gridLineColor: "transparent",
                    resize: true,
                    barSizeRatio: 0.25,
        ...
        var areaChart = function () {
            ...
            Morris.Area({
                ...
                lineColors: ["#5e72e4", "rgb(16, 202, 147)", "rgb(255, 92, 0)"],
                xkey: "period",
                ykeys: ["smartphone", "windows", "mac"],
                labels: ["Phone", "Windows", "Mac"],
                pointSize: 0,
